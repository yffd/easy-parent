 ...
 * @see 	 
 */
public interface IPojoService<POJO> {
	 ...
	 * @return
	 */
	Integer save(List<POJO> pojoList, LoginInfo loginInfo);
	 ...
	 * @param pojoOld				条件-旧对象“属性名-值”集合
	 * @param loginInfo
	 * @return
	 */
	Integer update(POJO pojo, POJO pojoOld, LoginInfo loginInfo);
	 ...
	 * @return
	 */
	PageResult<POJO> findPageWithOrder(POJO pojo, String orderBy, LoginInfo loginInfo, PageParam page);
	 ...
	 * @return
	 */
	PageResult<POJO> findPage(POJO pojo, LoginInfo loginInfo, PageParam page);
