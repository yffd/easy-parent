...
public interface ICommonService<E> {
	 ...
	 * @return
	 */
	PageResult<E> findPageWithOrder(E entity, String orderBy, PageParam page, LoginInfo loginInfo);
	 ...
	 * @return
	 */
	PageResult<E> findPage(E entity, PageParam page, LoginInfo loginInfo);
