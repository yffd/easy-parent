...
public class MybatisCommonPartialTreeDaoImpl<E extends CommonPartialTreeEntity> extends MybatisCommonBaseDaoImpl<E> {
	...
	public E findTreeNode(E node) {
		...
		params.put(MybatisCommonGenericDaoSupport.PARAM_NAME_ENTITY, node);
		return this.customSelectOneBy(MybatisCommonGenericDaoSupport.SQL_ID_SELECT_ONE_BY, params, true);
	}
	...
	public List<E> findRootNodes(E node) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put(MybatisCommonGenericDaoSupport.PARAM_NAME_ENTITY, node);
		return this.customSelectListBy(MybatisCommonGenericDaoSupport.SQL_ID_SELECT_LIST_BY, params, true);
	}
	...
	public boolean existRootNode(E node) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put(MybatisCommonGenericDaoSupport.PARAM_NAME_ENTITY, node);
		int result = this.customSelectCountBy(MybatisCommonGenericDaoSupport.SQL_ID_SELECT_COUNT_BY, params, true);
		return (result > 0);
	}
	...
	public int addRootNode(E node) {
		...
		node.setParentCode("root");
		node.setNodeLayer(1);
		return this.customInsertBy(MybatisCommonGenericDaoSupport.SQL_ID_INSERT_ONE_BY, node, true);
	}
	...
	public E findParentNode(E node) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put(MybatisCommonGenericDaoSupport.PARAM_NAME_ENTITY, paramNode);
		return this.customSelectOneBy(MybatisCommonGenericDaoSupport.SQL_ID_SELECT_ONE_BY, params, true);
	}
	...
	public int addChildNode(E node) {
		...
		// 2.再插入节点
		int num = this.customInsertBy(MybatisCommonGenericDaoSupport.SQL_ID_INSERT_ONE_BY, node, true);
		return num;
	}
	...
	public int updateNodes(E node, E nodeOld) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put(MybatisCommonGenericDaoSupport.PARAM_NAME_ENTITY, node);
		params.put(MybatisCommonGenericDaoSupport.PARAM_NAME_ENTITY_OLD, nodeOld);
