 ...
 * @see 	 
 */
public class EasyTreeDataBuilderTest {
	...
	public void buildTreeTest() {
		...
		EasyTreeDataBuilder<EasyTestNode> builder = new EasyTreeDataBuilder<EasyTestNode>();
		
		// 2.1
		EasyTestNode tree2 = builder.buildTree(list, root);
