package com.yffd.easy.common.core.tree.node.custom;
 ...
 * @Date		 2018年5月18日 上午11:32:36 <br/>
 * @author       zhangST
 * @version		 1.0
 * @since		 JDK 1.7+
 * @see 	 
 */
public class EasyCustomTreeBuilderTest {
	...
	public void buildTreeTest() {
        ...
        List<EasyTestNode> list = new ArrayList<>();  
		...
		EasyCustomTreeBuilder<EasyTestNode, EasyTestTree> builder = new EasyCustomTreeBuilder<EasyTestNode, EasyTestTree>() {
		...
		// 2.1
//		EasyCustomTree tree2 = builder.buildTree(list, root);
//		String json2 = JSON.toJSONString(tree2);
//		System.out.println(json2);
		
		EasyTestTree tree2 = (EasyTestTree) builder.buildTree(list, root);
		String json2 = JSON.toJSONString(tree2);
		System.out.println(json2);
