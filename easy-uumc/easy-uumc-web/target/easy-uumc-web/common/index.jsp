...
function initMenuLocal() {
	var menuJson = [{
        ...
        "children": [{
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/sys/application/applicationMain.jsp",
            "rsType": "M"
        },{
        	"id": "sys-101",
            "pid": "sys",
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/sys/resource/resourceMain.jsp",
            "rsType": "M"
        },{
        	"id": "sys-103",
            "pid": "sys",
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/permission/permissionMain.jsp",
            "rsType": "M"
        }]
	},{
		"id": "16",
        ...
        "children": [{
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/user/userMain.jsp",
            "rsType": "M"
        },{
        	"id": "sys-182",
            "pid": "sys",
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/user/userCfg.jsp",
            "rsType": "M"
        }]
	},{
		"id": "19",
        ...
        "children": [{
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/role/roleMain.jsp",
            "rsType": "M"
        },{
        	"id": "sys-192",
            "pid": "19",
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/role/roleCfg.jsp",
            "rsType": "M"
        }]
	},{
		"id": "20",
        ...
        "children": [{
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/organization/organizationMain.jsp",
            "rsType": "M"
        }]
	},{
		"id": "21",
        ...
        "children": [{
            ...
            "state": "open",
            "iconCls": "icon-sys",
            "inUrl": "views/uumc/account/accountMain.jsp",
            "rsType": "M"
        }]
	}];
	var $ma = $("#menuAccordion");
