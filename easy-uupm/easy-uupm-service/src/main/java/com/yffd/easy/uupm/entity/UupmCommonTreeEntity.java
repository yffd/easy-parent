 ...
 * @see 	 
 */
public class UupmCommonTreeEntity extends CommonPartialTreeEntity implements IPOJO, Serializable {
	private static final long serialVersionUID = 4019222915807281217L;
	private String id;
